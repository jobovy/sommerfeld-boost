...
subhalos with very small velocity dispersions, moslty, but not
...
clusters from the Sloan Digital Sky Survey has shown that the halo
profiles of these objects are consistent with the \NFW\ profile and
mass-concentration relation given above \cite{2008JCAP...08..006M}.
...
%\includegraphics[clip=]{2dredboost8_65.eps}%%BoundingBox: 178 291 400 474
%\includegraphics[clip=]{2dredboost7_65.eps}%%BoundingBox: 190 291 430 474
\caption{The total boost for a $M=10^8$ \Msun\ subhalo assuming a
\GNFW\ dark matter density profile for the subhalos.}%
...
smaller values of \mv/\mdm, seems to be higher than one would expect
from the pure Sommerfeld enhancement combined with a boost factor from
pure density enhancements.
...
Figure \ref{fig:subboost} (\emph{lower panels}), in various parts of
...
distinguishable in this plot of the reduced boost as 45$\deg$
...
different inner slopes is irrelevant, and because the function $f(c)$
is only a weak function of the inner slope. This is confirmed by
calculating the total boost for a $M = 10^8$ \Msun subhalo for a
subhalo with a very shallow inner cusp as well as for a subhalo with a
very steep inner slope. These are shown in Figure
\ref{fig:subboostprofiles}, and, from comparing this with the total
boost shown in Figure \ref{fig:subboost}, it is clear that the inner
slope does not affect the total boost due to substructure. The main
difference between the different dark matter density profiles is
therefore given by the normalization of the $\lum \propto \rhos^2
\rs^3/\dist^2$ relation, shown in Figure \ref{fig:normgammaNFW}.

BOVY: describe different slopes $n$ here.

BOVY: Also describe different thermal free streaming limits here?

\section{Predicted annihilation signals for dwarf Spheroidals}

dSphs good candidates for \DM\ annihilation:
2000PhRvD..61b3514B,%Baltz/SUSY
2002PhRvD..66b3509T,%Tyler,Draco
...
\begin{figure*}[t]
\includegraphics[clip=]{flux_carina_65.eps}%%BoundingBox: 178 291 400 474
\includegraphics[clip=]{flux_draco_65.eps}\\%%BoundingBox: 190 291 430 474
\includegraphics[clip=]{flux_fornax_65.eps}%%BoundingBox: 178 291 400 474
\includegraphics[clip=]{flux_leoI_65.eps}\\%%BoundingBox: 190 291 430 474
\includegraphics[clip=]{flux_leoII_65.eps}\\%%BoundingBox: 178 291 400 474
%\includegraphics[clip=]{flux_sculptor_65.eps}\\%%BoundingBox: 190 291 430 474
\includegraphics[clip=]{flux_sextans_65.eps}%%BoundingBox: 178 291 400 474
\includegraphics[clip=]{flux_ursaminor_65.eps}%%BoundingBox: 190 291 430 474
\caption{}%
\label{fig:dsph}%
\end{figure*}
...
\section{The annihilation signal from subhalos in \VL\ 2}

\VL 2 data \cite{2008Natur.454..735D} \footnote{Available at
...
\caption{Distances and masses in \VL\ 2.}%\
\label{fig:VL23_1}%
\end{figure}
...
\caption{Photon count for individual subhalos and total boosts for \ldots.}%\
\label{fig:VL23_2}%
\end{figure}
...
\caption{Distribution of total photon counts for 1,000 random observers at 8.5 kpc.}%\
\label{fig:VL23_3}%
\end{figure}
...
Don't forget to mention the fact that the whole halo might be build up
of distinct streams with velocity dispersion of order 1 km/s, such
that the annihilation signal we might expect from the halo could be
much larger than that people have suggested.

{\bf Acknowledgments:}
Hogg. NASA NNX08AJ48G.
