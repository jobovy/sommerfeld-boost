...
\caption{The total boost for a $M=10^8$ \Msun\ subhalo for different shapes of the \DM\ density profile: a generalized \NFW\ profile described by an inner slope $\gamma$ (\emph{top panels}); an Einasto profile described by a shape parameter \alphaEinasto\ (\emph{bottom panels}).}%
...
= 10^{-3}$ \Msun, the substructure boost becomes relatively small
BOVY: BE MORE PRECISE HERE. When the free-streaming scale becomes very
small, much of the substructure is in very small, cold clumps, such
that the total boost becomes very large. BOVY: BE MORE PRECISE HERE.
...
radius of the main halo in \VL\ 2. The distances are for three random
...
in \VL\ 2 for three random observer placed at a distance of 8.5 kpc
...
\caption{Total gamma-ray flux from subhalos in \VL\ 2 for 1,000 random
