...
to do with the fact that the most probable relative velocity in a
Maxwell-Boltzmann relative velocity distribution is the velocity
dispersion. The Sommerfeld enhancement attains very large values for
...
subhalos that exist in \CDM\ will get large boosts to their \DM\
